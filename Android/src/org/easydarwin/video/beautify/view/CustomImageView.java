...
public class CustomImageView extends ImageView {
	...
	public CustomImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		for (int i = 0; i < n; i++) {
			...
			switch (attr) {
				case R.styleable.CustomImageView_cornerRadius:
					cornerRadius = CornerRadius.Parser.parse(a.getString(attr), context);
					if (cornerRadius != null) {
						cornerTopLeftRadius = cornerRadius.getTopLeftRadius() == null ? 0 : cornerRadius.getTopLeftRadius();
						cornerTopRightRadius = cornerRadius.getTopRightRadius() == null ? 0 : cornerRadius.getTopRightRadius();
						cornerBottomLeftRadius = cornerRadius.getBottomLeftRadius() == null ? 0 : cornerRadius.getBottomLeftRadius();
						cornerBottomRightRadius = cornerRadius.getBottomRightRadius() == null ? 0 : cornerRadius.getBottomRightRadius();
					}
					break;
				case R.styleable.CustomImageView_border:
					...
					break;
				case R.styleable.CustomImageView_shape:
					shape = a.getInt(attr, SHAPE_NONE);
					break;
				case R.styleable.CustomImageView_cornerTopLeftRadius:
					cornerTopLeftRadius = a.getDimension(attr, 0);
					break;
				case R.styleable.CustomImageView_cornerTopRightRadius:
					cornerTopRightRadius = a.getDimension(attr, 0);
					break;
				case R.styleable.CustomImageView_cornerBottomLeftRadius:
					cornerBottomLeftRadius = a.getDimension(attr, 0);
					break;
				case R.styleable.CustomImageView_cornerBottomRightRadius:
					cornerBottomRightRadius = a.getDimension(attr, 0);
					break;
				case R.styleable.CustomImageView_borderWidth:
					borderWidth = (int) a.getDimension(attr, 0);
					break;
				case R.styleable.CustomImageView_borderPadding:
					borderPadding = (int) a.getDimension(attr, 0);
					break;
				case R.styleable.CustomImageView_borderColor:
