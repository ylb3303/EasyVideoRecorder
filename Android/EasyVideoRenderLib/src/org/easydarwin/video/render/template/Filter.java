...
import org.easydarwin.video.render.core.ImageFilterTools;
import org.easydarwin.video.render.core.ParamKeeper;
import org.easydarwin.video.render.core.ImageFilterTools.FilterAdjuster;
...
//			gpuImageFilter.destroy();
			//android.util.Log.d("ExcecuteProject", "destroy filter:" + getFilterType());
			//			if(gpuImageFilter instanceof GPUImageTwoInputFilter){
...
//			gpuImageFilter = null;
	...
	public GPUImageFilter getGpuImageFilter() {
		if (gpuImageFilter == null) {
			...
			adjuster = new ImageFilterTools.FilterAdjuster(gpuImageFilter);
			if (adjuster != null) {
	...
	public void setFadeOut(int fadeOut) {
		this.fadeOut = fadeOut / (1000 / ParamKeeper.get().getFrameRate());//this.getFrameRate()
	}

	public void setFadeIn(int fadeIn) {
		this.fadeIn = fadeIn / (1000 / ParamKeeper.get().getFrameRate());//this.getFrameRate()
	}
