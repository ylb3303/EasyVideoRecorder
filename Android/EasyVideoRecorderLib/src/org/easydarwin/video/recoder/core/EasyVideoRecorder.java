...
public class EasyVideoRecorder implements EventPoster.OnEventListener {
	...
	private RecorderConfig config = RecorderConfig.createDefault();
	...
	private boolean prepare() {
		...
		File tmpDir = new File(config.getVideoTmpDir());
		if (!tmpDir.exists()) {
			if (!tmpDir.mkdirs()) {
	...
	public EasyVideoRecorder setRecordTimeMax(long recordTimeMax) {
		config.setRecordTimeMax(recordTimeMax);
		return this;
	}

	public EasyVideoRecorder setRecordTimeMin(long recordTimeMin) {
		config.setRecordTimeMax(recordTimeMin);
		return this;
	}

	public EasyVideoRecorder setBaseDir(String baseDir) {
