...
public class VideoFocusView extends RelativeLayout {
	...
	public VideoFocusView(Context context, AttributeSet attrs) {
		...
		mFocusImg.setBackgroundResource(R.drawable.easy_video_record_image_focus);
		addView(mFocusImg);

		if (isShowFilpCamrea()) {
			mChangeCamera = new ImageView(context);
			mChangeCamera.setBackgroundResource(R.drawable.easy_video_record_chage_camrea_arrow);
